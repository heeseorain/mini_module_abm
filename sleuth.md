...
3. Download dataset (sample data of Sejong, South Korea): [Urban_2018.zip](https://github.com/heeseorain/mini_module_abm_data/blob/main/Urban_2018.zip){:target="_blank"}, [Exclusion_2014.zip](https://github.com/heeseorain/mini_module_abm_data/blob/main/Exclusion_2018.zip){:target="_blank"}, [Road_2018.zip](https://github.com/heeseorain/mini_module_abm_data/blob/main/Road_2018.zip){:target="_blank"}, and [Boundary.zip](https://github.com/heeseorain/mini_module_abm_data/blob/main/Boundary_2018.zip){:target="_blank"} in the working directory (you don't need to unzip). (Note: The original dataset are from the Korea National Spatial Infrastructure Portal. We have simplified and edited the file contents for the supervision).
