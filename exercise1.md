...
- Go through at your own pace. If you don't manage to go through all Qs, you can resume in the final session (5pm). If you finish quickly, there are more exercises on Game of Life in [[Extra Exercise]](./life_wolf.md){:target="_blank"}.
...
If you are interested, there are more exercises on Wolf Sheep Predation in [[Extra Exercise]](./life_wolf.md){:target="_blank"}.
